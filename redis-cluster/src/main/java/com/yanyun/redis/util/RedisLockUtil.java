package com.yanyun.redis.util;

import com.yanyun.redis.lock.DistributedLocker;
...
public class RedisLockUtil {
    ...
    private static DistributedLocker distributedLocker = (DistributedLocker) SpringContextUtil.getBean("distributedLocker");
